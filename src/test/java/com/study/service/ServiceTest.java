...
//                    .isThrownBy(() -> {
//                        boardService.findBoardAndCommentAndFile(1L);
//                    })
...
//
//            // when
//            boardService.findBoardAndCommentAndFile(boardIdx);
//
//            // then
...
//                        .build();
//
//                when(boardRepository.findBoardFile(boardIdx)).thenReturn(board);
//
//                // when
...
//                        .build();
//
//                Board selectBoardDTO = new Board();
//
//                Board updateReturnBoardDTO = new Board();
